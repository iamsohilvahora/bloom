...
<div id="primary" class="">
	<main id="main" class="site-main" role="main">
		...
		$taxonomy = "courses_taxonomies";	
		$image_id = get_term_meta($category_id, 'upload_featured_image', true);
			...
			<div class="sight-portfolio-area">
				...
				<div class="sight-portfolio-area-filter" id="myBtnContainer">
					...
					<ul class="sight-portfolio-area-filter__ul_list">
						<li class="sight-portfolio-area-filter__list-item sight-category-list courses1-category-list sight-filter-all sight-filter-active" data-id="<?php echo $category_id; ?>">
							<a href="#" class="btn active">All</a>
						</li>
	                	<?php 
	                	foreach($sub_cats as $sub_category): ?>
	                		<li class="sight-portfolio-area-filter__list-item sight-category-list courses1-category-list" data-id="<?php echo $sub_category->term_id; ?>">
				...
				<div class="sight-portfolio-area__pagination sight-portfolio-area__pagination_course">
					<button class="sight-portfolio-load-more-btn course1-load-btn" data-total-post="5" data-category-id="<?php echo $category_id; ?>">Load More</button>
				</div>
				<?php endif; ?>
			</div>
		</div>
