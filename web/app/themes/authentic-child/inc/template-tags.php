		...
		if(is_author()){
			...
			<div class="author-avatar">
				<a href="<?php echo esc_url( get_author_posts_url( $id ) ); ?>" rel="author">
					<?php 
						$contributor_image = get_field('image', 'user_' . $id);
						if(!empty($contributor_image)): ?>
						    <img src="<?php echo $contributor_image['url']; ?>" alt="<?php echo $contributor_image['alt']; ?>" width="300" height="300" />
						<?php
						else:
							echo get_avatar( $id, '240' ); 
						endif;
					?>
				</a>
			</div>
